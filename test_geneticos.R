...
model <- read.table("Total_FPIES/total_fpies_assoc/model_totalfpies_varselect.model", header = TRUE)
bim <- read.table("Total_FPIES/total_fpies_assoc/total_fpies_vs_khor.bim", header = FALSE, 
                  col.names = c("CHR", "VAR", "CENT", "POS", "ALT", "REF"))
assoc <- read.table("Total_FPIES/total_fpies_assoc/totalfpies_varselect_assoc.assoc", header = TRUE)
